...
export default (__exports) => {
    ...
    return {
        ...
        ZC39ZCtinyaplzm0zi6zi0zi0zminplacezmtinyaplzmjsZCMainZC: async ($1, $2) => { await $1($2); },
        ZC40ZCtinyaplzm0zi6zi0zi0zminplacezmtinyaplzmjsZCMainZC: async ($1) => { return await $1(); },
        ZC41ZCtinyaplzm0zi6zi0zi0zminplacezmtinyaplzmjsZCMainZC: async ($1) => { return await fetch($1).then(x => x.text()); },
